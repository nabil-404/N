...
def nems():
	print W+B+"[*]"+W+" NABIL IS WRITING ALL NUMBER WAIT ..."
...
def main():
	...
	Buy 50k This Tool Contact Me FACEBOOK rafi.569
		...
		print """
	Tittle\t  : Made By Nabil (TEAM-404)
	Coder\t  : Nabil Rahman
	Pronhub\t  : I Don't Watch Pron Vedio
	Coder  : Nabil Rahman
		
	(C) Copyright EDIT 2020 By Nabil Rahman
	 	 """
	 	raw_input( W+R+"[!]"+W+" Nabil Says Prees Enter To Menu ...")
	 	os.system('clear')
	 	main()
